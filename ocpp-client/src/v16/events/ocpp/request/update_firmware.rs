...
use crate::v16::{cp::ChargePoint, interfaces::{ChargePointInterface, TimerId}, state_machine::firmware::{FirmwareDownloadInfo, FirmwareState}};


impl<I: ChargePointInterface> ChargePoint<I> {
    pub(crate) async fn update_firmware_ocpp(&mut self, unique_id: String, req: UpdateFirmwareRequest) {
        ...
        match self.firmware_state {
            FirmwareState::Idle => {
                ...
                if diff.num_seconds() > 0 {
                    ...
                    self.add_timeout(TimerId::Firmware, diff.num_seconds() as u64).await;
                } else {
